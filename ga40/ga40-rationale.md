...
While the above rationale addresses the procedural requirements specified by the constitution, there was some concern regarding the intent of this treasury withdrawal governance action, and whether is sufficiently met the requirements of Article III, Section 5, which states “Sufficient rationale shall be provided to justify the requested change to the Cardano Blockchain.”

This governance action provides a description of what the Scalus platform is and what it does, however it does not provide any information about what the requested treasury funds will be used for.  It could be assumed that the funds are intended to finance the development of the platform, or that it is a service fee to operate an existing application for the Cardano community to use.  However, the lack of a simple explanation regarding what the proposal will use the funds to deliver, meant that it did not meet the threshold for “sufficient rationale” for one of our members.

## Conclusion
This governance action was determined by a majority of the Eastern Cardano Council to have sufficiently fulfilled the criteria specified for treasury withdrawals in the Cardano Constitution, so is deemed constitutional.
